class User < ApplicationRecord
  ...
  has_many :follows_outbound, class_name: 'Follow', foreign_key: 'follower_id', inverse_of: 'follower'
  has_many :follows_inbound, class_name: 'Follow', foreign_key: 'followee_id', inverse_of: 'followee'
